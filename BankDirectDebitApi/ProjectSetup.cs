using BankDirectDebitApi.Configurations;
using BankDirectDebitApi.Data;
using BankDirectDebitApi.HostedServices;
using BankDirectDebitApi.Services;
using BankDirectDebitApi.Services.Auth;
using BankDirectDebitApi.Services.BankDirectDebit;
using BankDirectDebitApi.Startups;
...
namespace BankDirectDebitApi
{
    public static class ProjectSetup
    {
        ...
        public static IServiceCollection ConfigDependency(this IServiceCollection services, IConfiguration configuration)
        {
            ...
            services.AddScoped<IBankDirectDebitServices, BankDirectDebitServices>();
